...
if CLIENT then
	...
	SWEP.IronsightPos = Vector(-3.21, 0, 1)
	SWEP.IronsightAng = Vector(-0.1, -0.42, 3)
...
SWEP.RailBGs = {main = 4, regular = 0, yeah = 1}
...
SWEP.Attachments = {
	...
	[4] = {header = "Magazine", offset = {550, 550}, atts = {"ha_akm_extmag"}},
