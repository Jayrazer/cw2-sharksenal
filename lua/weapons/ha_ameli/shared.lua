...
if CLIENT then
	...
	local function removeRoundMeshes(wep) -- if we're low enough on ammo such that the belt no longer visually connects with the box, remove all bullet meshes so they don't float around on the reload
		if wep:Clip1() <= 14 then
